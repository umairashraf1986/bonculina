	...
	class WDAP_Delivery_Area extends FC_Plugin_Base {
		...
		*/
		...
		function wdap_zip_search_markup( $id, $zipcode ) {
			...
			$html .='<div id="wdap_zip_check" class="wdap_zip_form_container '.esc_attr( $class ).' '.esc_attr($delivery_wrapper).'">
				...
				$html .='<input type="button" style="'.esc_attr( $style ).'" value ="'.esc_attr( $submit_button_label ).'" id="wdapzipsumit" class="wdapzipsumit single_add_to_cart_button button alt '.esc_attr( $arrow ).'"  />';
				$zipcode_test_desc='';
