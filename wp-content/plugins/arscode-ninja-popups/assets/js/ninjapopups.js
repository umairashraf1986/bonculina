...
function snp_bld_gotostep(popup_id, nextstep)
{
    ...
    if (cur_step.data('animation-close') !== undefined) {
        ...
        cur_step.off('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend');
    ...
    if (next_step.attr('data-animation') !== undefined) {
        next_step.off('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend');
