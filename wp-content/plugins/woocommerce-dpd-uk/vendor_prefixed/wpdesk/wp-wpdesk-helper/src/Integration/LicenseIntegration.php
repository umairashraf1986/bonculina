...
use DpdUKVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \DpdUKVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \DpdUKVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \DpdUKVendor\WPDesk\License\Page\LicensePage($plugin_registry);
