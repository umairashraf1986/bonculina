...
if (!\interface_exists('DpdUKVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('DpdUKVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('DpdUKVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \DpdUKVendor\WPDesk_Translatable, \DpdUKVendor\WPDesk_Buildable, \DpdUKVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
