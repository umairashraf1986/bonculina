...
use DpdUKVendor\WPDesk\License\ServerAddressRepository;
 ...
 */
class LicenseActivation implements \DpdUKVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    public function execute(array $plugin)
    {
        ...
        $this->activate_license($activation_email, $api_key, new \DpdUKVendor\WPDesk\License\ServerAddressRepository($product_id));
    }
    /**
     ...
     */
    public function activate_license($activation_email, $api_key, \DpdUKVendor\WPDesk\License\ServerAddressRepository $address_repository)
    {
