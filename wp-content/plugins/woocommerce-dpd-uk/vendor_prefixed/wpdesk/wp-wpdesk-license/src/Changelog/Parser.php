...
namespace DpdUKVendor\WPDesk\License\Changelog;

use ArrayObject;
use DpdUKVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \DpdUKVendor\WPDesk\License\Changelog\Parser\Line($line);
