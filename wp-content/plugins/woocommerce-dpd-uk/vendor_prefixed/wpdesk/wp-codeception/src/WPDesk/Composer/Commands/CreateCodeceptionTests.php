...
use DpdUKVendor\Composer\Downloader\FilesystemException;
 ...
 */
class CreateCodeceptionTests extends \DpdUKVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \DpdUKVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
