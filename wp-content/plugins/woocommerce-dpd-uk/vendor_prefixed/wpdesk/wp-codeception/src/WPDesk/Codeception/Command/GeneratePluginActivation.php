 ...
 */
class GeneratePluginActivation extends \DpdUKVendor\Codeception\Command\GenerateTest implements \DpdUKVendor\Codeception\CustomCommandInterface
{
    /**
    ...
    {
        return new \DpdUKVendor\WPDesk\Codeception\Command\AcceptanceTestGenerator($config, $class);
    }
    /**
     * Execute command.
     *
