 ...
 */
class BrowserConsoleHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \DpdUKVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
