...
class ZendMonitorHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    public function __construct($level = \DpdUKVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
        ...
        $this->levelMap = array(\DpdUKVendor\Monolog\Logger::DEBUG => \DpdUKVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, \DpdUKVendor\Monolog\Logger::INFO => \DpdUKVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, \DpdUKVendor\Monolog\Logger::NOTICE => \DpdUKVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, \DpdUKVendor\Monolog\Logger::WARNING => \DpdUKVendor\ZEND_MONITOR_EVENT_SEVERITY_WARNING, \DpdUKVendor\Monolog\Logger::ERROR => \DpdUKVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, \DpdUKVendor\Monolog\Logger::CRITICAL => \DpdUKVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, \DpdUKVendor\Monolog\Logger::ALERT => \DpdUKVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, \DpdUKVendor\Monolog\Logger::EMERGENCY => \DpdUKVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR);
