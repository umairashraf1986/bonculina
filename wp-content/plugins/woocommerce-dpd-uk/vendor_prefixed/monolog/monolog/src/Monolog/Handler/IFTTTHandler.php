 ...
 */
class IFTTTHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $eventName;
    private $secretKey;
    /**
     ...
     */
    public function __construct($eventName, $secretKey, $level = \DpdUKVendor\Monolog\Logger::ERROR, $bubble = \true)
    {
