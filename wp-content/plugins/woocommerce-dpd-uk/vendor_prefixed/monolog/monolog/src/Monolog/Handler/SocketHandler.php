 ...
 */
class SocketHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \DpdUKVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
