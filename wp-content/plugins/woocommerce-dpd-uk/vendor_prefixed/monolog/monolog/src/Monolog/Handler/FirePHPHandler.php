...
use DpdUKVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \DpdUKVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
