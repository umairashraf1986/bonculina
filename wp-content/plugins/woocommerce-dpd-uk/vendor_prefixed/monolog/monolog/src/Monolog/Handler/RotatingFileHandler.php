 ...
 */
class RotatingFileHandler extends \DpdUKVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \DpdUKVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \DpdUKVendor\Monolog\Utils::canonicalizePath($filename);
