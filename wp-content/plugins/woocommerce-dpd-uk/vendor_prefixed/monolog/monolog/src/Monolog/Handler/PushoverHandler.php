 ...
 */
class PushoverHandler extends \DpdUKVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \DpdUKVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \DpdUKVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \DpdUKVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \DpdUKVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \DpdUKVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
