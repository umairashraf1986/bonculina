...
use DpdUKVendor\Gelf\IMessagePublisher;
use DpdUKVendor\Gelf\PublisherInterface;
use DpdUKVendor\Gelf\Publisher;
...
class GelfHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($publisher, $level = \DpdUKVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
        parent::__construct($level, $bubble);
        if (!$publisher instanceof \DpdUKVendor\Gelf\Publisher && !$publisher instanceof \DpdUKVendor\Gelf\IMessagePublisher && !$publisher instanceof \DpdUKVendor\Gelf\PublisherInterface) {
