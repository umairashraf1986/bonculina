 ...
 */
class SlackbotHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \DpdUKVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
